...
// //                                     <Select
// //                                         id='category1'
// //                                         options={specialization?.map((category: Category) => ({
// //                                             value: category.id,
// //                                             label: category.name
// //                                         }))}
// //                                         onChange={(selectedOption: any) => {
...
//     // Добавляем запрос для получения специализаций
//     const {
//         data: specialization,
...
//         queryKey: ['specialization', currentLanguage],
//         queryFn: async () => {
//             const response = await fetch(`http://176.124.210.145:8088/quiz/specialization`)
//             if (!response.ok) {
//                 throw new Error('Network response was not ok')
//             }
//             const data = await response.json()
